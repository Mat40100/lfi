...
Ghost (post publié)
   ...
   ▼
n8n  (conteneur, réseau lfi_web) ── Caddy TLS ──► n8n.adour-en-commun.fr (éditeur web)
   │
...
- [ ] **DNS** : `A n8n.adour-en-commun.fr → 37.59.103.153` (zone OVH, comme `forum`)
...
```yaml
  n8n:
    ...
    environment:
      N8N_HOST: n8n.adour-en-commun.fr
      N8N_PROTOCOL: https
      N8N_PORT: 5678
      WEBHOOK_URL: https://n8n.adour-en-commun.fr/
      N8N_EDITOR_BASE_URL: https://n8n.adour-en-commun.fr/
